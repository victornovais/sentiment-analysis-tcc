...
\begin{figure}[H]
	...
	\center
	\subfigure[sentilexpos][Lista de termos positivas]{\includegraphics[width=7cm]{figuras/sentilexpos.eps}}
	\qquad
	\subfigure[sentilexneg][Lista de termos negativas]{\includegraphics[width=7cm]{figuras/sentilexneg.eps}}
