...
Todas as bases, já normalizadas, podem ser encontradas no Apêndice A deste trabalho. 
...
\todo{Colocar a foto das bases originais}
\begin{lstlisting}[style=shared, frame=single, caption=Base de palavras original]
SUBSTANTIVOS [+]
alegria, atemporalidade, beleza, bem-estar, best-seller, brilho, carisma, companheirismo, deleite, densidade, diferencial, empatia, entusiasmo, envolvente, facilidade, favorito, fluidez, genialidade, gostinho, grandeza, ironia, magnetismo, obra-prima, originalidade, prazer, predileto, preferido, primor, sensibilidade, sufocamento, talento, taquicardia, ternura, top, virtude

SUBSTANTIVOS [-]
besteira, bobagem, bosta, chatice, defeito, demorar, desastre, desconforto, desprazer, droga, engano, erro, exagero, excesso, falhar, falho, falta, furo, imaturidade, inexperiente, lixar, meleca, melodrama, meloso, mundo,  nojo, passividade, pena, pieguice, porca, porcaria, problema, sentimentalismo, superficialidade, vergonha
